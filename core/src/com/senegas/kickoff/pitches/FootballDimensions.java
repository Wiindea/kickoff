...
public class FootballDimensions {
	/* 1 inch = 2,54 cm */
	...
	public static final int LEFT_POST_OUTEREDDGE_X = 0x194;
	public static final int RIGHT_POST_OUTEREDGE_X = 0x1FC;
	public static final int CROSSBAR_TOPEDGE = 0x24;
	public static final int LEFT_POST_INNEREDGE_X = 0x19C;
	public static final int RIGHT_POST_INNEREDGE_X = 0x1F4;
	public static final int CROSSBAR_BOTEDGE = 0x1C;

	/**
	 * The height of the pitch in pixel (given by the original Kick Off graphics)
	 */
	public static final double PITCH_HEIGHT_IN_PX = 1392;

	/** The width of the pitch in pixel (given by the original Kick Off graphics) */
	public static final double PITCH_WIDTH_IN_PX = 912;

	/**
	 * The Football pitch half height in pixel (696 px, given by the original Kick
	 * Off graphics)
	 */
	public static final double HALF_PITCH_HEIGHT_IN_PX = PITCH_HEIGHT_IN_PX / 2;

	/**
	 * The Football pitch half width in pixels (456 px, given by the original Kick
	 * Off graphics)
	 */
	 ...
	 * with a radius of 9.15 m (10 yds)
	 */
	...
	/**
	 * An arc of a circle with a radius of 9.15 m (10 yds) from each penalty mark is
	 * drawn outside the penalty area.
	 */
	public static final double PENALTY_ARC_RADIUS = 9.15;

	/**
	 * A penalty area is defined at each end of the field as follows: Two lines are
	 * drawn at right angles to the goal line, 16.5 m (18 yds) from the inside of
	 * each goalpost. These lines extend into the field of play for a distance of
	 * 16.5 m (18 yds) and are joined by a line drawn parallel with the goal line.
	 ...
	 * joined at the top by a horizontal crossbar. The distance between the posts is
	 * 7.32 m (8 yds)
	 */
