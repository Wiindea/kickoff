...
public class Team implements Disposable {
	...
	public Team(Match match, String name, Direction direction) {
		...
		this.texture = direction == Direction.NORTH ? new Texture("entities/style1a.png")
				: new Texture("entities/style1b.png");
	...
	private void createPlayers() {
		Vector3 playerPosition = new Vector3(0, (int) (Pitch.PITCH_HEIGHT_IN_PX / 2 + Pitch.OUTER_TOP_EDGE_Y + 16
				+ (direction == Direction.NORTH ? -16 : 16)), 0);
		for (int i = 0; i < 10; i++) {
	...
	public void setupIntroduction() {
		Vector3 playerPosition = new Vector3(0, (int) (Pitch.PITCH_HEIGHT_IN_PX / 2 + Pitch.OUTER_TOP_EDGE_Y + 16), 0);
